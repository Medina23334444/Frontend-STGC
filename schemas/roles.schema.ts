...
export const RoleSchema = z.object({
  ...
  description: z.string().nullable().optional().default(null), // ✅ Fuerza null
...
export const CreateRoleSchema = z.object({
  name: z.string().min(1, 'El nombre es obligatorio').max(50),
  description: z.string().max(255).nullable().optional().default(null), // ✅ Fuerza null
